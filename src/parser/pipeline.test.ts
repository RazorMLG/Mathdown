...
describe('Headings', () => {
  ...
  it('renders heading with inline bold', () => {
    expect(pipeline('# Hello **world**')).toBe('<h1>Hello <strong>world</strong></h1>')
  })
})
...
describe('Paragraph', () => {
  ...
  it('renders bold italic', () => {
    expect(pipeline('***bolditalic***')).toContain('<em><strong>bolditalic</strong></em>')
  })
  ...
  it('renders link', () => {
    expect(pipeline('[text](https://example.com)')).toContain('<a target="_blank" rel="noopener" href="https://example.com">text</a>')
  })

  it('renders image', () => {
    expect(pipeline('![alt](https://example.com/img.png)')).toContain('<img src="https://example.com/img.png" alt="alt">')
  })
})
